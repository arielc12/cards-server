...
const { registerUser, getUser, updateUser, getUsers, login } = require("../models/usersAccessDataService");
...
router.get("/:id", auth, async (req, res) => {
    try {
        ...
        if (userInfo._id !== id && !userInfo.isAdmin) {
            return handleError(res, 403, "you are not autherized to get this user");
        }
